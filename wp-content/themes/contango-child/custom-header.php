<div id="headimg">
  ...
  <div id="logo-image">
    <!--need to override php header_image to load new image-->
    <!--Therefore need to trace exact path generated by function header_image()-->
    <!--commented by author: Pratik Manandhar Date:27/12/2015-->
