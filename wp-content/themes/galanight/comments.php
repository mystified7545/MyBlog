...
<div id="comments" class="comments-area<?php if ( $galanight_options_db['galanight_next_preview_post'] == 'Display' || $galanight_options_db['galanight_next_preview_post'] == '' ) { ?> comments-area-post<?php } ?>">
